...
task copy_libraries {
	...
	Copy-Item ([System.IO.Path]::Combine($nuget_packages_directory, 'kCura.Relativity.Client.9.5.335.7', 'lib', 'net462', 'kCura.Relativity.Client.dll')) $lib_directory	
	Copy-Item ([System.IO.Path]::Combine($nuget_packages_directory, 'Relativity.ImportExport.9.5.335.7', 'lib', 'net462', 'kCura.Relativity.DataReaderClient.dll')) $lib_directory	
	Copy-Item ([System.IO.Path]::Combine($nuget_packages_directory, 'Relativity.ImportExport.9.5.335.7', 'lib', 'net462', 'kCura.WinEDDS.dll')) $lib_directory
	Copy-Item ([System.IO.Path]::Combine($nuget_packages_directory, 'Relativity.ImportExport.9.5.335.7', 'lib', 'net462', 'kCura.WinEDDS.Core.dll')) $lib_directory	
	Copy-Item ([System.IO.Path]::Combine($nuget_packages_directory, 'Relativity.ImportExport.9.5.335.7', 'lib', 'net462', 'kCura.WinEDDS.TApi.dll')) $lib_directory
