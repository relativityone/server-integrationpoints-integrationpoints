...
#Constants
$PSBoundParameters['RelativityServicesUrl'] = "/Relativity.Services"
$PSBoundParameters['RelativityRestUrl'] = "/Relativity.Rest/api"
$PSBoundParameters['RelativityWebApiUrl'] = "/RelativityWebAPI/"
$PSBoundParameters['SuppressCertificateCheck'] = "true"
