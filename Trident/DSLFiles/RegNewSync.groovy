...
multibranchPipelineJob('IntegrationPoints-Jobs/IntegrationPoints-Regression/IntegrationPoints-Regression-New-Sync') {
    factory {
        workflowBranchProjectFactory {
            scriptPath('Trident/Jobs/Reg-NewSync.groovy')
        }
    }
    branchSources {
        branchSource {
            source {
                git {
                    ...
                    id('IntegrationPoints-Reg-New-Sync')
                }
            }
        }
    }
