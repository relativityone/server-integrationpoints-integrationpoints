		...
		public void Install(IWindsorContainer container, IConfigurationStore store)
		{
			...
			container.Register(
				Component.For<GetApplicationBinaries>()
					...
					.DynamicParameters((k, d) => d["eddsDBcontext"] = ConnectionHelper.Helper().GetDBContext(-1))
					.LifestyleTransient());
			...
			//container.Register(
			//	Component.For<IOnBehalfOfUserClaimsPrincipalFactory>()
			...
			//container.Register(
			//	Component.For<IConnectorFactory>().ImplementedBy<ConnectorFactory>().LifestyleSingleton().OnlyNewServices());
			//container.Register(
			...
			container.Register(Component.For<IImportPreviewService>().ImplementedBy<ImportPreviewService>());
				//todo: bp 10/7/2016 this might need to be a singleton
			...
			container.Register(Component.For<IFieldParserFactory>().ImplementedBy<FieldParserFactory>());
			...
			//		.ImplementedBy<RdoSynchronizerPush>()
			//		.Named(typeof(RdoSynchronizerPush).AssemblyQualifiedName)
			//		.LifeStyle.Transient);
			//container.Register(
			//	Component.For<IDataSynchronizer>()
			//		.ImplementedBy<RdoSynchronizerPull>()
			//		.Named(typeof(RdoSynchronizerPull).AssemblyQualifiedName)
			//		.LifeStyle.Transient);
			//container.Register(
			//	Component.For<IDataSynchronizer>()
			//		.ImplementedBy<RdoCustodianSynchronizer>()
			//		.Named(typeof(RdoCustodianSynchronizer).AssemblyQualifiedName)
			//		.LifeStyle.Transient);
			//container.Register(
			//	Component.For<IDataSynchronizer>()
			...
			//container.Register(
			//	Component.For<ISynchronizerFactory>()
			//		.ImplementedBy<GeneralWithCustodianRdoSynchronizerFactory>()
			//		.DependsOn(new {container = container})
			//		.LifestyleTransient());
			//container.Register(
			//	Component.For<ISynchronizerFactory>()
			//		.ImplementedBy<ExportDestinationSynchronizerFactory>()
			//		.DependsOn(new {container = container})
			//		.LifestyleTransient());
			...
			//container.Register(
			//	Component.For<IDirectoryTreeCreator<JsTreeItemDTO>>()
			//		.ImplementedBy<DirectoryTreeCreator<JsTreeItemDTO>>()
			//		.LifestyleTransient());
			...
			//container.Register(
			//	Component.For<IFileQuery>().ImplementedBy<kCura.IntegrationPoints.Data.Queries.FileQuery>().LifeStyle.Transient);
