...
TooltipDefs.RelativityProviderSettingsDetails = [
    ...
    {
        name: "Copy Images",
        description: "determines whether Integration Points copies images while syncing data between the source and destination workspaces. When you select Yes, only images are transferred by the integration point and no documents. When you additionally select Yes for the Copy Natives setting, integration point transfers physical image files to the fileshare of the destination workspace.",
        subsection: []
    },
	{
