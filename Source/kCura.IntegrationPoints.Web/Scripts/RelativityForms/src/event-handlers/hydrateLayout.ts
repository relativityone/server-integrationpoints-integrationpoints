...
import { formatToYesOrNo, getExportType, getPrecenenceSummary, getSourceDetails } from "../helpers/fieldValuesForRelativityExport";
...
export function setFieldsValues(layoutData, convenienceApi: IConvenienceApi, sourceConfiguration: Object, destinationConfiguration: Object) {
    ...
    // export 
    convenienceApi.fieldHelper.setValue("Export Type", getExportType(sourceConfiguration, destinationConfiguration));
    convenienceApi.fieldHelper.setValue("Source Details", getSourceDetails(sourceConfiguration, destinationConfiguration["ArtifactTypeName"]));
    ...
    convenienceApi.fieldHelper.setValue("Use Folder Path Info", formatToYesOrNo(destinationConfiguration["UseDynamicFolderPath"]));
