...
namespace kCura.IntegrationPoints.EventHandlers.Tests.Commands
{
	...
	{
		private UpdateLdapConfigurationCommand _sut;
		...
		public override void SetUp()
		{
			...
			_sut = new UpdateLdapConfigurationCommand(EHHelperFake.Object, RelativityObjectManagerMock.Object,
		...
		public void Execute_ShouldProcess()
		{
			...
			_splitServiceFake.Setup(x => x.Split(decryptedConfiguration, _USERNAME_FIELD_NAME, _PASSWORD_FIELD_NAME)).Returns(splittedConfiguration);
