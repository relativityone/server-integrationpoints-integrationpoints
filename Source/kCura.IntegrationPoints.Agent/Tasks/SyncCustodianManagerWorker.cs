...
namespace kCura.IntegrationPoints.Agent.Tasks
{
	public class SyncCustodianManagerWorker : SyncWorker
	{
		...
		public SyncCustodianManagerWorker(ICaseServiceContext caseServiceContext, IDataProviderFactory dataProviderFactory,
			...
			IDataReaderWrapperFactory dataReaderWrapperFactory, IContextContainerFactory contextContainerFactory,
			IJobService jobService, IRepositoryFactory repositoryFactory, IProviderTypeService providerTypeService)
