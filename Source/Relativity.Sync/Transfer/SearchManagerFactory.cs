...
namespace Relativity.Sync.Transfer
{
	internal class SearchManagerFactory : ISearchManagerFactory
	{
		...
		private async Task<ISearchManager> SearchManagerFactoryAsync()
		{
			...
			NetworkCredential credentials = LoginHelper.LoginUsernamePassword(AuthConstants._RELATIVITY_BEARER_USERNAME, authToken, cookieContainer, runningContext, () => string.Empty);
