...
namespace Relativity.Sync.Progress
{
    internal sealed class JobProgressHandler : IJobProgressHandler
    {
        ...
        {
            SyncBatchProgress batchProgress = new SyncBatchProgress(
                batch.ArtifactId,
                totalItems: batch.TotalDocumentsCount,
                failedItemsCount: batch.FailedItemsCount,
                transferredItemsCount: batch.TransferredItemsCount);
        ...
        private Task UpdateProgressAsync()
        {
            ...
            Progress progress = new Progress(totalProcessedItems, totalFailedItems, totalProcessedItems);
