...
{
	internal sealed class DocumentSynchronizationExecutor : IExecutor<ISynchronizationConfiguration>
	{
		...
		public DocumentSynchronizationExecutor(IImportJobFactory importJobFactory,
