...
namespace Relativity.Sync.Executors
{
	internal sealed class DocumentRetryDataSourceSnapshotExecutor : IExecutor<IDocumentRetryDataSourceSnapshotConfiguration>
	{
		...
		public DocumentRetryDataSourceSnapshotExecutor(ISourceServiceFactoryForUser serviceFactory, IFieldManager fieldManager, IJobProgressUpdaterFactory jobProgressUpdaterFactory,
