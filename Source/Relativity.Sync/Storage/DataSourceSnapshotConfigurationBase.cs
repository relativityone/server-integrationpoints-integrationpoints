...
{
	internal abstract class DataSourceSnapshotConfigurationBase : IDataSourceSnapshotConfiguration, IFieldConfiguration
	{
		...
		public DataSourceSnapshotConfigurationBase(IConfiguration cache, IFieldMappings fieldMappings, SyncJobParameters syncJobParameters)
		{
			_cache = cache;
