...
{
	internal abstract class DataSourceSnapshotConfigurationBase : IDataSourceSnapshotConfiguration, IRetryDataSourceSnapshotConfiguration
	{
		...
		public DataSourceSnapshotConfigurationBase(IConfiguration cache, SyncJobParameters syncJobParameters)
		{
			_cache = cache;
