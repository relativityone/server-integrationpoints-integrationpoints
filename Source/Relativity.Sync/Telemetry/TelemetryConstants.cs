namespace Relativity.Sync.Telemetry
{
	internal static class TelemetryConstants
	{
		...
		public static class MetricIdentifiers
		{
			...
			public static readonly string DATA_LONGTEXT_STREAM_AVERAGE_SIZE_LESSTHAN1MB = $"{_INTEGRATION_POINTS_METRIC_PREPEND}.Data.LongTextStream.AverageSize.LessThan1MB";
			public static readonly string DATA_LONGTEXT_STREAM_AVERAGE_TIME_LESSTHAN1MB = $"{_INTEGRATION_POINTS_METRIC_PREPEND}.Data.LongTextStream.AverageTime.LessThan1MB";

			public static readonly string DATA_LONGTEXT_STREAM_AVERAGE_SIZE_BETWEEN1AND10MB = $"{_INTEGRATION_POINTS_METRIC_PREPEND}.Data.LongTextStream.AverageSize.Between1And10MB";
			public static readonly string DATA_LONGTEXT_STREAM_AVERAGE_TIME_BETWEEN1AND10MB = $"{_INTEGRATION_POINTS_METRIC_PREPEND}.Data.LongTextStream.AverageTime.Between1And10MB";

			public static readonly string DATA_LONGTEXT_STREAM_AVERAGE_SIZE_BETWWEEN10AND20MB = $"{_INTEGRATION_POINTS_METRIC_PREPEND}.Data.LongTextStream.AverageSize.Between10And20MB";
			public static readonly string DATA_LONGTEXT_STREAM_AVERAGE_TIME_BETWWEEN10AND20MB = $"{_INTEGRATION_POINTS_METRIC_PREPEND}.Data.LongTextStream.AverageTime.Between10And20MB";

			public static readonly string DATA_LONGTEXT_STREAM_AVERAGE_SIZE_OVER20MB = $"{_INTEGRATION_POINTS_METRIC_PREPEND}.Data.LongTextStream.AverageSize.Over20MB";
			public static readonly string DATA_LONGTEXT_STREAM_AVERAGE_TIME_OVER20MB = $"{_INTEGRATION_POINTS_METRIC_PREPEND}.Data.LongTextStream.AverageTime.Over20MB";

			public static readonly string DATA_LONGTEXT_STREAM_LARGEST_SIZE = $"{_INTEGRATION_POINTS_METRIC_PREPEND}.Data.LongTextStream.LargestLongText.Size";
			public static readonly string DATA_LONGTEXT_STREAM_LARGEST_TIME = $"{_INTEGRATION_POINTS_METRIC_PREPEND}.Data.LongTextStream.LargestLongText.Time";
