...
{
	internal sealed class DocumentSynchronizationExecutionConstrains : IExecutionConstrains<IDocumentSynchronizationConfiguration>
	{
		private readonly IBatchRepository _batchRepository;
		private readonly ISyncLog _syncLog;

		public DocumentSynchronizationExecutionConstrains(IBatchRepository batchRepository, ISyncLog syncLog)
		{
			_batchRepository = batchRepository;
			_syncLog = syncLog;
		}

		public async Task<bool> CanExecuteAsync(IDocumentSynchronizationConfiguration configuration, CancellationToken token)
		{
