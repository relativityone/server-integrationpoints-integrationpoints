...
namespace Relativity.Sync.Tests.Unit.Storage
{
    internal class ImageJobStartMetricsConfigurationTests : ConfigurationTestBase
    {
        ...
        public void SetUp()
        {
            ...
            _sut = new ImageJobStartMetricsConfiguration(_configuration, _serializer, new SyncJobParameters(1, _SOURCE_WORKSPACE_ARTIFACT_ID, _USER_ID, _WORKFLOW_ID, Guid.Empty));
        }
