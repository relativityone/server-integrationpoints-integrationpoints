...
namespace Relativity.Sync.Tests.Unit
{
    ...
    public class JobProgressUpdaterTests
    {
        ...
        {
            return null;//return new JobProgressUpdater(_serviceFactory.Object, _rdoGuidConfiguration.Object, _WORKSPACE_ID, _JOB_HISTORY_ID, _dateTime.Object, _jobHistoryErrorRepository.Object, _ripWorkarounds.Object, _syncJobParameters, new EmptyLogger());
        }
