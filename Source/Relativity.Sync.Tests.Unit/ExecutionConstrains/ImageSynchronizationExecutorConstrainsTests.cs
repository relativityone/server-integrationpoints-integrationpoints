...
namespace Relativity.Sync.Tests.Unit.ExecutionConstrains
{
    ...
    public class ImageSynchronizationExecutorConstrainsTests
    {
        private CancellationToken _token;
        private IAPILog _syncLog;

        private Mock<IImageSynchronizationConfiguration> _synchronizationConfiguration;
        ...
        public void OneTimeSetUp()
        {
            ...
            _synchronizationConfiguration = new Mock<IImageSynchronizationConfiguration>(MockBehavior.Loose);
        }
        ...
        public async Task<bool> CanExecuteAsyncGoldFlowTests(IEnumerable<int> batchIds)
        {
            ...
            var synchronizationExecutorConstrains = new ImageSynchronizationExecutionConstrains(batchRepository.Object, _syncLog);
