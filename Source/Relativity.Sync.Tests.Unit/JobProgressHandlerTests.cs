...
namespace Relativity.Sync.Tests.Unit
{
    ...
    public sealed class JobProgressHandlerTests : IDisposable
    {
        ...
        public void AttachToImportJob_ShouldReportProperNumberOfItems(int numberOfItemProcessedEvents, int numberOfItemErrorEvents, int expectedNumberOfItemsProcessed)
        {
            ...
            // Aassert
            _jobProgressUpdaterMock.Verify(x => x.UpdateJobProgressAsync(new Progress.Progress(expectedNumberOfItemsProcessed, numberOfItemErrorEvents, 0)));
        }
        ...
        public void AttachToImportJob_ShouldUpdateStatisticsWhenBatchCompletes()
        {
            ...
            // Assert
            _jobProgressUpdaterMock.Verify(x => x.UpdateJobProgressAsync(new Progress.Progress(itemsProcessed, itemsWithErrors, 0)));
        }
        ...
        public void AttachToImportJob_ShouldAggregateProgressFromMultipleBatches()
        {
            ...
            // Assert
            _jobProgressUpdaterMock.Verify(x => x.UpdateJobProgressAsync(new Progress.Progress(batchCount, batchCount, 0)));
        }
        ...
        public void AttachToImportJob_ShouldAggregateProgressAndCompleteFromMultipleBatches()
        {
            ...
            _jobProgressUpdaterMock.Verify(x => x.UpdateJobProgressAsync(new Progress.Progress(expectedTransferredItemsCount, 1, 0)));
        }
        ...
        public void AttachToImportJob_ShouldReportCorrectValues_WhenProgressUpdaterThrows()
        {
            ...
            _jobProgressUpdaterMock.Verify(x => x.UpdateJobProgressAsync(new Progress.Progress(expectedReportCount, 0, 0)), Times.AtLeastOnce);
        }
        ...
        public void AttachToImportJob_ShouldUpdateWithTotalTransferredAndFailedItems_WhenThereWerePreviouslyExecutedBatches()
        {
            ...
            _jobProgressUpdaterMock.Verify(x => x.UpdateJobProgressAsync(new Progress.Progress(expectedTransferredRecordsCount, expectedFailedRecordsCount, 0)));
        }
