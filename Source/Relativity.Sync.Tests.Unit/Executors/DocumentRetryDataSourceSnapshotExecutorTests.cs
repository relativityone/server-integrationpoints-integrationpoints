...
{
	[TestFixture]
	internal sealed class DocumentRetryDataSourceSnapshotExecutorTests
	{
		private DocumentRetryDataSourceSnapshotExecutor _instance;

		private Mock<IObjectManager> _objectManager;
		private Mock<IDocumentRetryDataSourceSnapshotConfiguration> _configuration;
		...
		public void SetUp()
		{
			...
			_instance = new DocumentRetryDataSourceSnapshotExecutor(serviceFactory.Object, _fieldManager.Object, jobProgressUpdaterFactory.Object,
