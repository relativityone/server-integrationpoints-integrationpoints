...
namespace Relativity.Sync.Tests.Unit.Transfer
{
    ...
    public sealed class NonDocumentBatchDataReaderBuilderTest
    {
		...
		public void SetUp()
		{
			...
			_fieldManagerMock.Setup(fm => fm.GetNonDocumentAllFieldsAsync(CancellationToken.None)).ReturnsAsync(_getAllFieldsResult);
		...
		public async Task BuildAsync_ShouldInvokeGetNonDocumentAllFieldsAsync()
		{
			...
			_fieldManagerMock.Verify(x => x.GetNonDocumentAllFieldsAsync(It.IsAny<CancellationToken>()));
