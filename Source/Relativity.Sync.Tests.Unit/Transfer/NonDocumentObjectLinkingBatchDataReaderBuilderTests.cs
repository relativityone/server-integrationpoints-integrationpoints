...
{
    [TestFixture]
    public sealed class NonDocumentObjectLinkingBatchDataReaderBuilderTests
    {
		...
		public void SetUp()
		{
			...
			_fieldManagerMock.Setup(fm => fm.GetMappedFieldsNonDocumentForLinksAsync(CancellationToken.None)).ReturnsAsync(_getAllFieldsResult);
		...
		{
			// Arrange
			var builder = new NonDocumentObjectLinkingBatchDataReaderBuilder(_fieldManagerMock.Object, _exportDataSanitizerFake.Object, new EmptyLogger());
			...
			_fieldManagerMock.Verify(x => x.GetMappedFieldsNonDocumentForLinksAsync(It.IsAny<CancellationToken>()));
		...
		{
			// Arrange
			NonDocumentObjectLinkingBatchDataReaderBuilder builder = new NonDocumentObjectLinkingBatchDataReaderBuilder(_fieldManagerMock.Object, _exportDataSanitizerFake.Object, new EmptyLogger());
