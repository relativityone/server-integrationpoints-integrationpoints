...
namespace Relativity.Sync.Tests.Unit
{
	...
	public sealed class DataSourceSnapshotConfigurationTests
	{
		...
		public void SetUp()
		{
			...
			_instance = new DataSourceSnapshotConfiguration(_cache.Object, _fieldMappings.Object, new SyncJobParameters(1, _WORKSPACE_ID, Guid.NewGuid(), new ImportSettingsDto()));
		}
