...
{
    public interface IIntegrationPointBaseFieldGuidsConstants
    {
        ...
        string CalculationState { get; }
    }

    public class IntegrationPointFieldGuidsConstants : IIntegrationPointBaseFieldGuidsConstants
    {
        ...
        public string CalculationState => IntegrationPointFieldGuids.CalculationState;
    }

    public class IntegrationPointProfileFieldGuidsConstants : IIntegrationPointBaseFieldGuidsConstants
    {
        public string NextScheduledRuntimeUTC => IntegrationPointProfileFieldGuids.NextScheduledRuntimeUTC;

        public string LastRuntimeUTC => Guid.Empty.ToString();
        ...
        public string JobHistory => Guid.Empty.ToString();
