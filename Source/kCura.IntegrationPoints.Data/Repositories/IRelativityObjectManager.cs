...
namespace kCura.IntegrationPoints.Data.Repositories
{
	public interface IRelativityObjectManager
	{
		...
		Task<bool> MassUpdateAsync(MassUpdateByObjectIdentifiersRequest request, MassUpdateOptions updateOptions, ExecutionIdentity executionIdentity = ExecutionIdentity.CurrentUser);
		...
		System.IO.Stream StreamLongText(int relativityObjectArtifactId, FieldRef longTextFieldRef, bool isUnicode, ExecutionIdentity executionIdentity = ExecutionIdentity.CurrentUser);
	}
}
