...
namespace kCura.IntegrationPoints.Data.Repositories
{
	public interface IRelativityObjectManager
	{
		...
		Task<System.IO.Stream> StreamLongTextAsync(RelativityObjectRef exportObject, FieldRef longTextField, ExecutionIdentity executionIdentity = ExecutionIdentity.CurrentUser);
	}
}
