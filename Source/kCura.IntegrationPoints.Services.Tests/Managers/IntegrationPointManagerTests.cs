...
namespace kCura.IntegrationPoints.Services.Tests.Managers
{
	public class IntegrationPointManagerTests : TestBase
	{
		...
		public void ItShouldHideAndLogException()
		{
			...
			var integrationPointRepository = Substitute.For<IIntegrationPointRepository>();
			...
			_container.Resolve<IIntegrationPointRepository>().Returns(integrationPointRepository);
