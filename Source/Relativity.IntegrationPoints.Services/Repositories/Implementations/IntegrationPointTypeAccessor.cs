...
{
    public class IntegrationPointTypeAccessor : IIntegrationPointTypeAccessor
    {
        private readonly IRelativityObjectManagerService _relativityObjectManagerService;

        public IntegrationPointTypeAccessor(IRelativityObjectManagerService relativityObjectManagerService)
        {
