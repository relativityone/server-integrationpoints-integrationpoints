...
namespace kCura.IntegrationPoints.SourceProviderInstaller.Tests.Internals
{
    ...
    public class KeplerSourceProviderInstallerTests
    {
        ...
        private Mock<IServicesMgr> _servicesManagerMock;
        ...
        public void SetUp()
        {
            ...
            _servicesManagerMock = new Mock<IServicesMgr>();
            _servicesManagerMock
                .Setup(x =>
            ...
            var keplerRequestHelper = new KeplerRequestHelper(_loggerMock.Object, _servicesManagerMock.Object, numberOfRetriesForKeplerCalls, 0);
