...
namespace kCura.IntegrationPoints.FilesDestinationProvider.Core.Validation
{
	public class FileDestinationProviderValidationMessages
	{
		...
		public static readonly string SETTINGS_IMAGES_PREFIX_ILLEGAL_CHARACTERS = "Selected images subdirectory prefix contains illegal characters (<>:\\\"\\\\\\/|\\?\\*).";
		...
		public static readonly string SETTINGS_NATIVES_PREFIX_ILLEGAL_CHARACTERS = "Selected natives subdirectory prefix contains illegal characters (<>:\\\"\\\\\\/|\\?\\*).";
		...
		public static readonly string SETTINGS_TEXTFILES_PREFIX_ILLEGAL_CHARACTERS = "Selected text files subdirectory prefix contains illegal characters (<>:\\\"\\\\\\/|\\?\\*).";
		...
		public static readonly string SETTINGS_VOLUME_PREFIX_ILLEGAL_CHARACTERS = "Selected volume subdirectory prefix contains illegal characters (<>:\\\"\\\\\\/|\\?\\*).";
	}
}