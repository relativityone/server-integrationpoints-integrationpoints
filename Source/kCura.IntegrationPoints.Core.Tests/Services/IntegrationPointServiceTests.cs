...
namespace kCura.IntegrationPoints.Core.Tests.Services
{
    ...
    public class IntegrationPointServiceTests
    {
        ...
        public void MarkIntegrationPointToStopJobs_ShouldThrowAndAggregateProcessingAndPendingExceptions()
        {
            ...
            _jobHistoryServiceMock.Setup(x => x.UpdateRdoToBeChanged(It.IsAny<Data.JobHistory>()))
            ...
            _jobHistoryServiceMock.Verify(x => x.UpdateRdoToBeChanged(It.IsAny<Data.JobHistory>()), Times.Exactly(numberOfPendingJobs));
        }
