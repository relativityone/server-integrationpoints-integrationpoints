...
namespace kCura.IntegrationPoints.Core.Tests
{
    ...
    public class BatchEmailTests : TestBase
    {
        ...
        {
            return JobHelper.GetJob(1337, null, null, 1, 1, 111, _INTEGRATION_POINT_ID, Guid.NewGuid().ToString(), TaskType.ExportManager, new DateTime(), null, "", 0, new DateTime(), 1, null, null);
        }
    }
}
