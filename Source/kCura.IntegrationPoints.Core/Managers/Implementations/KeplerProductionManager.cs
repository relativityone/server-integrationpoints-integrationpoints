...
namespace kCura.IntegrationPoints.Core.Managers.Implementations
{
    class KeplerProductionManager : IProductionManagerWrapper
    {
        ...
        {
            IEnumerable<ProductionDTO> productions = Task.Run(() => _productionRepository.GetProductionsForExportAsync(workspaceArtifactId))
        ...
        {
            IEnumerable<ProductionDTO> productions = Task.Run(() => _productionRepository.GetProductionsForImportAsync(workspaceArtifactId))
                .ConfigureAwait(false).GetAwaiter().GetResult();
            return productions;
        }
