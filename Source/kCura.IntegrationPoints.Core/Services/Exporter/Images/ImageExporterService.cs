...
namespace kCura.IntegrationPoints.Core.Services.Exporter
{
	public class ImageExporterService : ExporterServiceBase
	{
		...
		{
            //Expected input formats for Original Image - DocumentName_DocumentNumber_INDEX_GUID OR DocumentNameDocumentNumber_INDEX_GUID OR DocumentName_DocumentNumber OR DocumentNameDocumentNumber
            ...
            else if (imageFileNameSplitted?.Length == 1 || imageFileNameSplitted?.Length == 3)  //Orignal; expected DocumentNameDocumentNumber || DocumentNameDocumentNumber_INDEX_GUID
            {
