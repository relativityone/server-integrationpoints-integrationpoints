...
namespace kCura.IntegrationPoints.Core.Validation.RelativityProviderValidator
{
	public class RelativityProviderValidationMessages
	{
		...
		public static readonly string FIELD_MAP_FIELD_NOT_EXIST_IN_DESTINATION_WORKSPACE = "Destination field mapped may no longer be available or has been renamed. Please review mapping for field '{0}'.";
