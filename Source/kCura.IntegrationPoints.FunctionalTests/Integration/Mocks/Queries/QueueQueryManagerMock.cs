...
namespace Relativity.IntegrationPoints.Tests.Integration.Mocks.Queries
{
    class QueueQueryManagerMock : IQueueQueryManager
    {
        ...
        public static List<KeyValuePair<long, string>> JobDetailsUpdateExecutions { get; set; } = new List<KeyValuePair<long, string>>();
        ...
        public IQuery<DataTable> CreateScheduledJob(int workspaceId, int relatedObjectArtifactId, string correlationID,
        ...
        public ICommand UpdateJobDetails(long jobId, string jobDetails)
        {
            return new ActionCommand(() =>
            {
                ...
                if (job != null)
                {
                    ...
                    JobDetailsUpdateExecutions.Add(new KeyValuePair<long, string>(jobId, jobDetails));
                }
            });
        }
        ...
        private JobTest CreateJob(long jobId, int workspaceId, int relatedObjectArtifactId, string correlationID,
            string taskType, DateTime nextRunTime, int agentTypeId, string scheduleRuleType,
