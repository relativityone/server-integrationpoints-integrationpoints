...
namespace kCura.IntegrationPoints.FilesDestinationProvider.Core.Tests.Services
{
	...
	public class WebAPIViewServiceTests : TestBase
	{
		private WebAPIViewService _subjectUnderTest;
		...
		public override void SetUp()
		{
			...
			_subjectUnderTest = new WebAPIViewService(serviceManagerProviderMock, helper);
		}
