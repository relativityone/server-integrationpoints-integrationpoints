...
try {
    ...
    if (passed) {
        mail body: 'https://tt-jnk-poland.testing.corp/view/All/job/Integration%20Points', subject: 'Integration Points Pipeline PASSED', to: 'bmollus@kcura.com'
    } else {
        mail body: 'https://tt-jnk-poland.testing.corp/view/All/job/Integration%20Points', subject: 'Integration Points Pipeline FAILED', to: 'bmollus@kcura.com'
    }
}
