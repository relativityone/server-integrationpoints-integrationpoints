...
## [1.0.3] - 2019-10-30
### Changed
- Added InternalsVisibleTo for kCura.IntegrationPoints.Domain to Contracts and SourceProviderInstaller projects, for kCura.IntegrationPoints.Core to SourceProviderInstaller project and for kCura.IntegrationPoints.EventHandlers to Contracts project to allow RIP to build properly.
