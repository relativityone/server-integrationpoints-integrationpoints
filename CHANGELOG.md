...
## [1.0.3] - 2019-10-30
### Changed
- Added InternalsVisibleTo for kCura.IntegrationPoints.Domain to Contracts and SourceProviderInstaller projects and for kCura.IntegrationPoints.Core to SourceProviderInstaller project to allow RIP to build properly.
