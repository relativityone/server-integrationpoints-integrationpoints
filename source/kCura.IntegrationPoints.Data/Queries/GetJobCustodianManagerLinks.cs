...
namespace kCura.IntegrationPoints.Data.Queries
{
    public class GetJobCustodianManagerLinks
    {
        ...
        public GetJobCustodianManagerLinks(IRepositoryFactory repositoryFactory, IDBContext caseDBcontext)
        {
        ...
        public DataTable Execute(string tableName, long jobID, int workspaceID)
        {
            ...
            var sql = string.Format(Resources.Resource.GetJobCustodianManagerLinks, scratchTableRepository.GetResourceDBPrepend(), tableName);
