...
namespace kCura.IntegrationPoints.Data.Queries
{
	public class JobHistoryErrorQuery
	{
		...
		public virtual JobHistoryError GetJobErrorFailedStatus(int jobHistoryId)
		{
			...
			var choiceJobErrorCondition = new SingleChoiceCondition(Guid.Parse(JobHistoryErrorFieldGuids.ErrorType), SingleChoiceConditionEnum.AnyOfThese, new List<Guid> { Guid.Parse("FA8BB625-05E6-4BF7-8573-012146BAF19B") });
			...
			{
				var choiceJobItemCondition = new SingleChoiceCondition(Guid.Parse(JobHistoryErrorFieldGuids.ErrorType), SingleChoiceConditionEnum.AnyOfThese, new List<Guid> { Guid.Parse("9DDC4914-FEF3-401F-89B7-2967CD76714B") });
