...
namespace kCura.IntegrationPoints.Agent.Tests.Tasks
{
	...
	public class ITaskFactoryTests : TestBase
	{
		...
		public void DropJobAndThrowException_NonScheduledJob_AgentExceptionThrown()
		{
			...
			//Assert
			_caseServiceContext.RsapiService.RelativityObjectManager.Received(1).Update(integrationPointDto);
		...
		public void CreateTask_UnableToResolveTaskType_JobHistoryIsUpdated(int? federatedInstanceArtifactId)
		{
			...
			_caseServiceContext.RsapiService.RelativityObjectManager.Read<Data.IntegrationPoint>(relatedId).Returns(new Data.IntegrationPoint()
			{
		...
		public void CreateTask_AllTaskTypesAreResolvable(TaskType taskType)
		{
			...
			rsapiService.RelativityObjectManager.Returns(objectManager);
			...
			objectManager.Read<Data.IntegrationPoint>(relatedId).Returns(integrationPoint);
