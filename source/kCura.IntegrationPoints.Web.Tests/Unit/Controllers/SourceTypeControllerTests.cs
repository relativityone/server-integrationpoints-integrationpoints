	...
	public class SourceTypeControllerTests
	{
		...
		public void Get_GoldFlow()
		{
			...
			StringAssert.AreEqualIgnoringCase(
				"[{\"name\":\"name\",\"id\":123,\"value\":\"d39d9a5e-e009-4c33-b112-73cc45c2ae2d\",\"url\":\"url\",\"config\":{\"CompatibleRdoTypes\":null,\"OnlyMapIdentifierToIdentifer\":false,\"ImportSettingVisibility\":{\"AllowUserToMapNativeFileField\":true}}}" +
				",{\"name\":\"name\",\"id\":123,\"value\":\"423b4d43-eae9-4e14-b767-17d629de4bb2\",\"url\":\"url\",\"config\":{\"CompatibleRdoTypes\":[10],\"OnlyMapIdentifierToIdentifer\":false,\"ImportSettingVisibility\":{\"AllowUserToMapNativeFileField\":false}}}]",
		...
		public void Get_GoldFlow_NoMatchRdoTypes()
		{
			...
			Assert.AreEqual(HttpStatusCode.OK, response.StatusCode);
			StringAssert.AreEqualIgnoringCase(
				"[{\"name\":\"name\",\"id\":123,\"value\":\"423b4d43-eae9-4e14-b767-17d629de4bb2\",\"url\":\"url\",\"config\":{\"CompatibleRdoTypes\":[],\"OnlyMapIdentifierToIdentifer\":false,\"ImportSettingVisibility\":{\"AllowUserToMapNativeFileField\":true}}}]",
				response.Content.ReadAsStringAsync().Result);
		}
		...
		public void Get_GoldFlow_NoMatchRdoTypes_ConfigNotNull()
		{
			...
			Assert.AreEqual(HttpStatusCode.OK, response.StatusCode);
			StringAssert.AreEqualIgnoringCase(
				"[{\"name\":\"name\",\"id\":123,\"value\":\"423b4d43-eae9-4e14-b767-17d629de4bb2\",\"url\":\"url\",\"config\":{\"CompatibleRdoTypes\":null,\"OnlyMapIdentifierToIdentifer\":false,\"ImportSettingVisibility\":{\"AllowUserToMapNativeFileField\":true}}}]",
				response.Content.ReadAsStringAsync().Result);
		}
		...
		public void Get_GoldFlow_NoMatchRdoTypes_CompatibleToMultipleRdos()
		{
			...
			Assert.AreEqual(HttpStatusCode.OK, response.StatusCode);
			StringAssert.AreEqualIgnoringCase(
				"[{\"name\":\"name\",\"id\":123,\"value\":\"423b4d43-eae9-4e14-b767-17d629de4bb2\",\"url\":\"url\",\"config\":{\"CompatibleRdoTypes\":[10,789456],\"OnlyMapIdentifierToIdentifer\":false,\"ImportSettingVisibility\":{\"AllowUserToMapNativeFileField\":true}}}]",
				response.Content.ReadAsStringAsync().Result);
		}
	}
}